  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      <div className="max-w-3xl mx-auto bg-white p-6 shadow-md rounded-lg">
        ...
        <p className="mb-4">
        Our products and services are targeted at users in India, and this Privacy Notice is intended to comply with the laws of India. If you are accessing or using the website or mobile application from an overseas location, you are requested to independently validate the impact of any applicable local laws. If you do not agree with this Privacy Notice at any time, in part or as a whole, write to our Grievance Office at the address specified below.
        </p>

        {/* Add more content as needed */}

        <h4 className="text-xl font-bold mt-4 mb-2">1. DEFINITIONS</h4>
        <p className="mb-4">
        In this Privacy Notice, the following definitions are used:
       </p>
        <h5 className="text-xl font-bold mt-4 mb-2">Cookies</h5>
       <li className="mb-2">
       a small file placed on your device by our website or mobile application when you either visit or use certain features of our website or mobile application. A cookie generally allows a website to remember your actions or preference for a certain period of time.
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Data</h5>
       <li className="mb-2">
       means personal information and SPDI about you, which either directly or indirectly in combination with other information, could allow you to be identified when you visit our [stores, website and/or mobile application].
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Data Protection Laws</h5>
       <li className="mb-2">
       any applicable law for the time being in force relating to the processing of Data, including the Information Technology Act, 2000 and Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Information) Rules, 2011, as amended or replaced from time to time.
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Partners</h5>
       <li className="mb-2">
       select third parties (including Tata Group Entities) with whom we have contracts or arrangements through which they may offer products or services to You or our other users, and to whom we may disclose your Data for a relevant purpose.
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Service Providers</h5>
       <li className="mb-2">
       includes entities to whom we, or other Tata Group Entities, will disclose your Data in order for them to process it for the purpose of providing services to us pursuant to written contract.
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">SPDI</h5>
       <li className="mb-2">
       the Data Protection Laws define sensitive personal data or information of a person as personal information about that person relating to (a) passwords; (b) financial information such as bank account credit and debit card details or other payment instrument details; (c) physical,Confidential physiological and mental health condition; (d) sexual orientation; (e) medical records and history; or (f) biometric information.
       </li>
        <h5 className="text-xl font-bold mt-4 mb-2">IRCPL</h5>
       <li className="mb-2">
       IRCPL, a company incorporated in India whose registered office is at Ranka Junction, No. 224 (old Sy No.80/3), 4th Floor, Vijinapura, Old Madras Road, K R Puram, Bangalore - 560016, India
       </li>
       <h5 className="text-xl font-bold mt-4 mb-2">User or you</h5>
       <li className="mb-5">
       the natural person who accesses our stores, website or mobile application.
      </li>

        <h4 className="text-xl font-semibold mt-6 mb-4">2. WHAT DATA DO WE COLLECT ABOUT YOU</h4>
        <p className="mb-4">
  IRCPL collects Data for various purposes set out in this Privacy Notice. This Data includes, without limitation, the following categories:
</p>
...
<ul className="list-disc ml-6 mb-4">
  ...
  <li className="mb-2">
    Transaction information: the date of the transaction, total amount, transaction history, preferences, and related details.
  </li>
  <li className="mb-2">
  ...
  <li className="mb-2">
    Your reviews, feedback, and opinions about our products, programs, and services.
  </li>
  <li className="mb-2">
    Loyalty program information: your loyalty membership information, account details, profile or password details, and any frequent flyer or travel partner program affiliation.
  </li>
  <li>
    Payment instrument information – through our application pages, you may choose a 3rd payment service provider of your choice for making payment and may agree to store your payment instrument details with the chosen service provider/s. The payment instrument data is managed by service provider/s.
  </li>
</ul>
        <h4 className="text-xl font-semibold mt-6 mb-2">3. HOW WE COLLECT DATA</h4>
...
<p>
  You can make choices about our collection and use of your Data. For example, you may want to access, edit or remove your Data on our website or mobile application. When you are asked to provide Data, you may decline, however, in such a case, you may not be able to avail the benefit of some of our products, programs, or services or access our stores or physical premises.
</p>
<h4 className="text-xl font-semibold mt-6 mb-2">4. SHARING OF DATA</h4>
<p className="mb-4">
...
<ol className="list-decimal ml-6 mb-4">
  <li className="mb-2">
    Partners: We may make available to you services, products, or applications provided by Partners for use on or through our website or mobile application. If you choose to use such a service, customer information related to those transactions may be shared with such Partner.
    <p className="mt-2">
  ...
  <li className="mb-2">
    When IRCPL acts as a Service Provider: We may process and share your Data with Tata Group Entities and Partners when we act as a service provider to such Tata Group Entities and Partners.
  </li>

  <li className="mb-2">
    Protecting IRCPL: We may release Data when we believe release is appropriate to comply with applicable law or legal process, enforce or apply the Terms of Use of our website or mobile application and other agreements, protect IRCPL against harm or financial loss, when we believe disclosure is necessary to protect individuals’ vital interests, or in connection with an investigation of suspected or actual fraudulent or illegal activity. This may include exchanging information with other companies and organizations for fraud protection, risk management, and dispute resolution. This does not include selling or otherwise disclosing personally identifiable information from users for commercial purposes in violation of this Privacy Notice.
  </li>
